...
const TGAColor ice_color = TGAColor(255, 180, 220, 180);
...
int main(int argc, char** argv) {
    ...
    if (argc == 2) {
        ...
        model = new Model("C:/Users/user/CLionProjects/KakSdelatKG/cmake-build-debug/obj/african_head.obj");
    }
    ...
    for (int view = 0; view < 4; view++) {
        ...
        std::cout << "1. Rendering back faces of cube... ";
        ...
        std::cout << "3. Rendering front (transparent) faces of cube... ";
